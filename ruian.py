...
class RuianFetcher(Connector):
    ...
    def ensure_length_limit(self, address: str) -> str:
        """
        make sure address is shorther than 40 chars
        """
        if len(address) > 40:
    ...
    def fetch_ruian_code(self, address: str) -> RuianCodeApiResponse:
        """
        Obtains ruian code given address
        """
        ...
        url = "https://vdp.cuzk.cz/vdp/ruian/adresnimista/fulltext"
    ...
    async def afetch_ruian_code(self, address: str) -> RuianCodeApiResponse:
        """
        asynchronous implementation of fetch ruian code
        """
        address = self.ensure_length_limit(address)  # TODO not sure if here is good place for applying this method
    ...
    def fetch_coordinates(self, address: str) -> CoordinatesAPIResponse:
        """
        obtains coordinates for given address
        """
    ...
    async def afetch_coordinates(self, address: str) -> CoordinatesAPIResponse:
        """
        asynchronous implementation of fetch coordinates
        """
        pass



    def run(self, column_name: str = 'undefined', file_path: str = '', server: str = '', db: str = '', in_table: str = '') -> None:
        """
    ...
    async def arun(self, column_name: str = 'undefined', file_path: str = '', server: str = '', db: str = '', in_table: str = '') -> None:
        """
